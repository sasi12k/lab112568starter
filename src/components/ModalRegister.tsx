...
export default function ModalRegister() {
  ...
  const cbAgreeTermsOnChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const computeTotalPayment = () => {
    ...
    // Apply 20% discount if all items are selected
  ...
  const hasDiscount = () => {
    return buyBottle && buyShoes && buyCap;
  };
